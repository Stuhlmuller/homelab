...
class SecretManagementTests(unittest.TestCase):
    ...
    def test_github_workflows_use_auth_keys_for_tailscale_access(self) -> None:
        ...
        self.assertNotIn("secrets.TS_OAUTH_CLIENT_ID", plan)
        self.assertNotIn("secrets.TS_OAUTH_SECRET", plan)
        self.assertNotIn("secrets.TS_OAUTH_CLIENT_ID", deploy)
        self.assertNotIn("secrets.TS_OAUTH_SECRET", deploy)
        ...
        self.assertNotIn("oauth-client-id:", action)
        self.assertNotIn("oauth-secret:", action)
        self.assertIn("tailscale-auth-key-parameter:", action)
        self.assertIn("aws ssm get-parameter", action)
        self.assertNotIn("mode=oauth", action)
