...
`https://nofx.stinkyboi.com`. The GitOps source is
...
- `/homelab/nofx/rsa-private-key` is a manual PEM placeholder.
- `/homelab/nofx/claw402-wallet-key` is a manual wallet-key placeholder.
