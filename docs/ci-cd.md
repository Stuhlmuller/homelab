...
The normal plan, apply, diagnostics, and break-glass recovery paths must keep
using `OCTELIUM_CI_AUTH_TOKEN` and the clientless `kubernetes-api-ci` Service.
Do not add kubeconfig material to the GitHub Actions jobs.
