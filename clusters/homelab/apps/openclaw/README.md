...
or updates the official `@openclaw/discord` channel plugin in pod-local plugin
storage, enables the plugin, and stores a SecretRef to the environment-backed
token.
