...
yq -o=json '.' "$cert_manager_values" \
  | jq -e '[
    ...
    >/dev/null
yq -e '
  .image.tag == "v1.96.2@sha256:80e5e92bdcca246cd4153d451e5f75b65e19c7e39c46cc88a38bed4b65cc5836" and
  .serviceAccount.create == true and
  .serviceAccount.automount == false and
  .serviceAccount.name == "litellm" and
  .podSecurityContext.seccompProfile.type == "RuntimeDefault" and
